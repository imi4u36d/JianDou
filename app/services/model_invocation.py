...
Translates the Java classes from apps/api-spring/model-invocation/:
- GenerationConfigPathLocator
- PromptTemplateResolver
- ImageProviderTransport / SeedreamImageModelProvider
- TextProviderTransport / OpenAiCompatibleTextModelProvider
- ChatCompletionsInvocationStrategy / ResponsesApiInvocationStrategy
- VideoProviderTransport / SeedanceVideoModelProvider
"""
...
from app.services.generation_service import GenerationProviderException
