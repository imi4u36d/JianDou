...
from jiandou_shared.config import Settings, load_settings
from jiandou_db.db import create_sqlalchemy_engine, init_database, build_session_factory
from jiandou_ai.planner import build_planner
from jiandou_storage.storage import MediaStorage
from jiandou_pipeline.service import TaskService
from jiandou_pipeline.worker import TaskWorker
...
def _build_redis_queue(settings: Settings):
    from jiandou_pipeline.worker import RedisJobQueue
