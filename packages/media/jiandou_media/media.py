...
from jiandou_shared.schemas import MediaProbe
...
def sample_audio_peaks(
    ...
    with tempfile.TemporaryDirectory(prefix="jiandou-audio-") as temp_dir:
...
def _render_crossfade_segments(
    ...
    with tempfile.TemporaryDirectory(prefix="jiandou-crossfade-") as temp_dir:
...
def compose_source_timeline(
    ...
    with tempfile.TemporaryDirectory(prefix="jiandou-multisource-") as temp_dir:
        temp_root = Path(temp_dir)
...
def render_output(
    ...
    with tempfile.TemporaryDirectory(prefix="jiandou-render-") as temp_dir:
        temp_root = Path(temp_dir)
