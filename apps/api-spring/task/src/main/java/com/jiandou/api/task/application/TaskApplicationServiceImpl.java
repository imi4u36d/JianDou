...
public class TaskApplicationServiceImpl implements TaskApplicationService {
    ...
    public Map<String, Object> adminGetTask(String taskId) {
        return taskQueryService.adminGetTask(taskId);
    }
    ...
    public Map<String, Object> getSeedanceTaskResult(String remoteTaskId) {
        Long userId = SecurityCurrentUser.requireCurrentUserId();
        var profile = modelResolver.resolveVideoProfile(taskDefaultsProperties.getSeedanceQueryModel(), userId);
     ...
     */
    @Override
    public Map<String, Object> adminTerminateTask(String taskId) {
        return taskQueryService.adminGetTask(taskCommandService.terminate(taskQueryService.requireTask(taskId)).id());
    }
