<template>
  <section class="admin-page admin-dashboard-view">
...
<style scoped>
.admin-dashboard-view :deep(.admin-panel) {
...
.admin-dashboard-view :deep(.admin-metric-card) {
  border-color: #dbe4ee;
  background: #f8fafc;
}

.admin-dashboard-view :deep(.admin-table th) {
  background: #f1f5f9;
}
</style>
