<template>
  <main class="home-page">
    <section class="home-hero">
      <HomeBrandPlay :focused="promptEditorFocused" :active="hasPromptInput" :submitting="submitting" />
...
const controls = useHomeComposerControls({
  ...
  setSelectedModeValue: (value) => { selectedModeValue.value = value; },
  form: () => form.value,
  prompt: () => promptText.value,
  setPrompt: (value) => { promptText.value = value; },
  ...
  clearReferenceImages: () => { referenceImages.value = []; },
  collapseReferences: () => { referenceExpanded.value = false; },
  authenticated: () => authState.isAuthenticated.value,
  credits: () => credits.value,
  saveAspectRatio: saveDefaultAspectRatio,
  authorizeCredits: () => requireAuth({
    title: "登录后查看积分",
