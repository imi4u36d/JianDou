...
class GenerationArtifactStore:
    def __init__(
        self, storage_root: str, web_origin: str, remote_object_store: RemoteObjectStore | None = None
    ) -> None:
    ...
    def _publish_artifact(self, storage_key: str, content: bytes, mime_type: str, file_name: str) -> str:
        """Keep generated bytes local so later model requests can resolve them as data URIs."""
